...
def services(request, year=datetime.now().year, month=datetime.now().strftime('%B')):
	name = "John"
...
def abcTrainerize(request):
    return render(request, 'events/abcTrainerize.html')


def inbodyScanning(request):
    return render(request, 'events/inbodyScanning.html')


def stretchingSessions(request):
    return render(request, 'events/stretchingSessions.html')


def personalTraining(request):
    return render(request, 'events/personalTraining.html')